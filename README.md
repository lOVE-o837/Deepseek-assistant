...
- 🔍 **双模式搜索** – 历史对话检索 + 当前页面内容搜索，支持关键词高亮与时间排序
- ⭐ **智能收藏夹** – 同时收藏对话和单条消息，支持备注和文件夹分类管理
- 📁 **文件夹管理** – 自定义文件夹，一键移动，轻松整理你的收藏
- 🎨 **6 套主题** – 深海蓝、经典黑、护眼绿……还可自定义取色器与跟随系统模式
- 🌐 **中英文切换** – 全界面一键切换语言，即时生效
- ⌨️ **高效快捷键** – `Alt+K` 呼出面板，`Ctrl+Shift+X` 收藏对话
...
> 也可在 [GitHub Releases](https://github.com/lOVE-o837/Deepseek-assistant/releases) 下载最新版本，使用开发者模式加载。
